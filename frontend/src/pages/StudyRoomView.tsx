    ...
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <div className="studyroom-nav">
        ...
        <div className="nav-center">
          <span className="active-feature-title">{getFeatureDisplayName(activeFeature)}</span>
        </div>
      ...
      <div className="flex h-[calc(100vh-70px)] study-view-container">
        ...
        <div className={`sidebar ${sidebarMinimized ? 'minimized' : ''}`}>
          ...
          <div className="sidebar-nav">
            ...
            >
              <span className="icon">🤖</span>
              {!sidebarMinimized && <span className="label">AI Chat Assistant</span>}
            </button>
            ...
            >
              <span className="icon">🎥</span>
              {!sidebarMinimized && <span className="label">Video Conference</span>}
            </button>
